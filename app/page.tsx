...
interface LyricTiming {
  ...
  color: string
  sender?: "user" | "kaguya" // Optional sender for chat messages
    ...
    >
                    ...
                    >
                      ...
                      <div className="bg-gray-50 px-4 py-3 border-b border-gray-200 flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h3 className="font-semibold text-gray-900 text-base">Zahraa❤️</h3>
      ...
      {!isPlaying && (
        ...
        >
          ...
          >
            Happy Brithday Zahraa ❤️ 
          </p>
          <p className="text-sm mt-4 text-gray-400">Made By Rakaa your secret worshiper</p>
        </motion.div>
      )}
    </motion.div>
  )
